...
const UserModal = ({ setOpenProfile }) => {
    ...
    <div className='absolute top-14 right-12'>
        <div className='bg-bgForm text-colorBlueDark rounded-lg shadow-md'>
            <div className='flex flex-col text-colorDark text-base'>
                <button onClick={() => setOpenProfile(true)} className='px-2 py-2 cursor-pointer hover:bg-slate-200 hover:rounded-t-lg flex items-center gap-x-1'><IoMdSettings className='h-5 w-5'/>ตั้งค่าโปรไฟล์</button>
