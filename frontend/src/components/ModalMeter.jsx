  ...
  return (
    <div className="bg-colorBlueDark/[.5] absolute w-screen z-20 h-screen">
      <div className="flex flex-col mt-[20vh] items-center h-screen shadow-md z-50">
        <div
          id="header"
          className="bg-bgModal w-2/4 z-50 flex items-center justify-between px-5 py-2 text-colorBlueDark"
        >
          <div>แก้ไขค่าน้ำ</div>
          <button
        ...
        <div id="footer" className="bg-bgModal w-2/4 py-3 px-5 text-end">
          <button
            className="py-2 px-5 rounded-md  hover:bg-slate-400 hover:scale-105 duration-300 active:scale-95  bg-colorBlueDark text-bgColor font-extralight text-base font-serif text-center"
            onClick={""}
          >
            บันทึก
          </button>
